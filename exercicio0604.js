...
var conta = Number(prompt("Número da Conta"));
var clientes = Number(prompt("Número de clientes"));
var valor = conta / clientes ;

console.log(`Número: ${conta.toFixed(2)}`);
...
var preço = Number(prompt("Preço do produto"));
var vista = preço * 0.10;
var por3 = preço / 3;

console.log(`Preço: ${preço.toFixed(2)}`);
console.log(`Vista: ${vista.toFixed(2)}`);
console.log(`3x: ${por3.toFixed(2)}`);
...
var n3 = Number(prompt("Insira a terceira média"));
